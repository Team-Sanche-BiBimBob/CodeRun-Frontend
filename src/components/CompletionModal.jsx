...
function CompletionModal({ 
  ...
  return (
    <div className="fixed inset-0 tran bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-8 w-[500px] text-center shadow-lg relative overflow-hidden">
        {/* 배경 장식 요소들 (파티클) */}
        <div className="absolute inset-0 overflow-hidden rounded-xl">
          <div className="absolute top-4 left-8 w-6 h-6 bg-green-200 rounded transform rotate-45 animate-pulse"></div>
          <div className="absolute top-12 right-16 w-4 h-4 bg-purple-200 rounded-full animate-pulse"></div>
          <div className="absolute top-16 left-20 w-8 h-4 bg-orange-200 rounded transform rotate-12 animate-pulse"></div>
          <div className="absolute top-6 right-8 w-5 h-8 bg-green-200 rounded transform rotate-45 animate-pulse"></div>
          <div className="absolute bottom-20 left-12 w-6 h-3 bg-purple-200 rounded transform rotate-45 animate-pulse"></div>
          <div className="absolute bottom-32 right-20 w-4 h-6 bg-orange-200 rounded transform rotate-12 animate-pulse"></div>
          <div className="absolute bottom-16 left-24 w-3 h-3 bg-green-200 rounded-full animate-pulse"></div>
          <div className="absolute bottom-8 right-12 w-7 h-4 bg-purple-200 rounded transform rotate-45 animate-pulse"></div>
          <div className="absolute top-20 left-32 w-2 h-2 bg-orange-300 rounded-full animate-pulse"></div>
          <div className="absolute top-32 right-32 w-8 h-3 bg-green-200 rounded transform rotate-45 animate-pulse"></div>
          <div className="absolute bottom-24 left-16 w-5 h-5 bg-purple-200 rounded transform rotate-12 animate-pulse"></div>
          <div className="absolute bottom-12 right-24 w-3 h-6 bg-orange-200 rounded transform rotate-45 animate-pulse"></div>
        </div>
